...
Plans:
- [ ] 03-01: GET /api/sync/quick-check, POST /api/sync/intervals/:type, POST /api/admin/sync/frequency
...
Plans:
- [ ] 07-01: Test E2E flussi critici (login → ordine → sync → verifica)
...
| 2. Critical Missing Endpoints | 2/4 | In progress | - |
