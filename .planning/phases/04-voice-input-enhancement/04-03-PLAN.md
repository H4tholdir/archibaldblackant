...
1. **Dettatura**: User speaks order details
2. **Form Pre-Fill**: Parsed entities populate form fields (NOT submitted)
3. **Manual Edit**: User can review and edit populated fields
4. **Tap Confirmation**: User explicitly confirms order creation
...
3. New behavior:
   ...
   ```
4. Add new state for tracking voice-populated fields:
   ```typescript
