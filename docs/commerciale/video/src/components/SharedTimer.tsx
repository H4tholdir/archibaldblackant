    ...
    <div style={{
      ...
      <div style={{
        ...
        {isWaiting ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 3 }}>
            <div style={{ fontSize: size * 0.21, fontWeight: 900, color: 'rgba(255,200,0,0.90)', fontFamily, letterSpacing: -1, lineHeight: 1 }}>
              {formatted}
            </div>
            <div style={{ fontSize: size * 0.11, fontWeight: 800, color: 'rgba(255,200,0,0.70)', fontFamily, letterSpacing: 0.5 }}>
              → ERP SYNC
            </div>
          </div>
        ) : (
