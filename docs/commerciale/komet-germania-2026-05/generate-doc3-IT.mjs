...
<div class="cover">
  ...
  <div class="cover-bottom">
    <div class="cover-meta-grid">
      ...
      <div class="cover-meta-item"><label>Destinatari</label><span>Komet Italia S.r.l.<br>Gebr. Brasseler GmbH &amp; Co. KG</span></div>
      <div class="cover-meta-item"><label>Data</label><span>Maggio 2026</span></div>
      <div class="cover-meta-item"><label>Validità offerta</label><span>31 Luglio 2026</span></div>
    </div>
  </div>
</div>
...
<div class="section pb-before">
  <h1><span class="n"></span>Prefazione</h1>
  <p class="lead">Questo documento è stato preparato su richiesta di Philipp Rovina (Gebr. Brasseler GmbH &amp; Co. KG) e di Marcello Sabatino (Komet Italia S.r.l.) per presentare formalmente la piattaforma Formicanera in vista di una potenziale adozione da parte della rete commerciale Komet Italia.</p>
  <p>Formicanera è una <strong>sales operations platform verticale</strong> per reti commerciali B2B, sviluppata e collaudata in produzione da un agente Komet con quarant'anni di esperienza nel settore. Non è un progetto accademico né un prototipo: è uno strumento attivo, usato ogni giorno su ordini e clienti reali, con una stabilità certificata nel tempo.</p>
  <p>Il documento che segue presenta l'analisi di mercato, la proposta economica e le condizioni contrattuali. Per la documentazione tecnica relativa alla sicurezza, conformità GDPR e NIS2, si rimanda al documento separato <em>"Formicanera Security &amp; Compliance Whitepaper"</em> indirizzato al team IT di Gebr. Brasseler.</p>
  <div class="callout callout-navy">
    <p><strong>Stato del prodotto:</strong> In produzione dal 2025 su dati reali. Integrazione ERP Archibald certificata e operativa. Pronto al rollout sulla rete Komet Italia entro 6–8 settimane dalla firma.</p>
  </div>
</div>
...
<div class="section pb-before">
  ...
  <table>
    <thead>
      <tr>
        ...
        <th style="width:20%">Costo anno 1 (60–80 utenti)</th>
      </tr>
    </thead>
    <tbody>
      <tr>
  ...
  <p class="market-note">* Costi indicativi per 60–80 utenti attivi. ERP e sviluppo custom includono implementazione, licenze e primo anno di manutenzione. Dati basati su listini pubblici Salesforce, HubSpot, Microsoft AppSource e benchmark di software house italiane di riferimento — Q1 2026.</p>
  ...
  <div class="include-cols">
    <div class="include-col col-yes">
      ...
      <ul>
        ...
        <li class="inc-y"><strong>Consulente tecnico dedicato — figura di riferimento unica per tutta la rete</strong></li>
      </ul>
    </div>
...
<div class="section">
  ...
  <div class="consulente-box">
    ...
    <div class="consulente-body">Il canone mensile non include solo la piattaforma — include l'accesso diretto alla persona che l'ha costruita e la fa girare ogni giorno. Non un consulente che ha studiato il vostro settore su un brief: con radici profonde nella rete Komet e nel settore dental, conosco il ciclo commerciale, l'ERP Archibald e le sue inefficienze dall'interno. Formicanera è nata esattamente da quella conoscenza, e quella conoscenza rimane disponibile per Komet.</div>
...
<div class="section pb-before" style="padding-top:28px;padding-bottom:20px;">
  ...
  <p style="font-size:9.5pt;color:var(--text-mid);line-height:1.6;margin-bottom:0;">Calcolo conservativo su 60–80 agenti attivi — dati misurati in produzione sul ciclo commerciale Komet.</p>
  ...
  <div class="roi-grid">
    <div class="roi-card">
      ...
      <div class="roi-card-desc">Da 15–20 minuti a 3–5. Il bot inserisce in Archibald in modo asincrono. Su 60–80 agenti × 3 ordini/giorno × 250 giorni: <strong>13.125 ore/anno recuperate</strong> solo sull'inserimento ordini.</div>
    </div>
    <div class="roi-card">
      <div class="roi-card-icon">📄</div>
      <div class="roi-card-value">−<span>7.000 h</span></div>
      <div class="roi-card-label">Documenti e coordinamento</div>
      <div class="roi-card-desc">DDT/fatture già sincronizzati: reperibili in <strong>1–2 minuti</strong> da qualsiasi dispositivo, senza aprire l'ERP e senza chiamare Verona (60–80 ag × 2/gg × 250 gg × 7,5 min = <strong>4.375 ore</strong>). Chiamate a Verona per status ordini quasi eliminate (60–80 ag × 1,5/gg × 250 gg × 6 min = <strong>2.625 ore</strong>).</div>
    </div>
    <div class="roi-card">
      <div class="roi-card-icon">🛡</div>
      ...
      <div class="roi-card-desc">60–80 agenti × ~50 clienti attivi = ~3.500 relazioni monitorate ogni giorno in automatico. La PWA notifica l'agente quando un cliente è a 4 mesi dalla soglia critica Komet. Perdere anche 1 sola esclusività territoriale può valere <strong>€20.000–50.000/anno</strong> in commissioni.</div>
    </div>
    <div class="roi-card">
      <div class="roi-card-icon">📊</div>
  ...
  <div style="break-inside:avoid-page;page-break-inside:avoid;">
    <div class="roi-total">
      <div>
        ...
        <div class="roi-total-sub">~20.000 ore totali × €35 costo orario medio agente · 60–80 agenti attivi<br>13.125 ordini + 7.000 documenti/coordinamento = 20.125 ore (calcolo per difetto)</div>
      </div>
...
<!-- ══════════════════ 4.2 BENCHMARK COMPETITIVO ══════════════════ -->
<div class="section pb-before">
  <h1><span class="n">4.2</span>Posizionamento di Mercato — Maggio 2026</h1>
  <p class="lead">Formicanera si posiziona nella fascia premium delle piattaforme field sales con integrazione ERP nativa — al prezzo dei concorrenti mid-range, con il vantaggio esclusivo di essere l'unica soluzione costruita specificamente per l'ERP Archibald e le normative italiane.</p>

  <table>
    <thead>
      <tr>
        <th style="width:22%">Vendor / Piano</th>
        <th style="width:18%">€/utente/mese<br>(anno 2+)</th>
        <th style="width:12%">ERP nativa</th>
        <th style="width:48%">Note critiche per Komet</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        ...
        <td>~€23</td>
        <td class="cross">✗</td>
        <td>Nessuna integrazione ERP nativa. Mercato emergente, nessun adattamento italiano.</td>
      </tr>
      <tr>
        <td><strong>Badger Maps Business</strong></td>
        <td>~€53</td>
        <td class="cross">✗</td>
        <td>Route optimization, ma nessun order management né integrazione ERP.</td>
      </tr>
      <tr>
        <td><strong>Skynamo Advanced</strong></td>
        <td>~€63</td>
        <td class="partial">Parziale</td>
        <td>Pricing opaco (richiede sales call). Implementazione ERP separata e a pagamento. Nessun adattamento italiano.</td>
      </tr>
      <tr class="highlight">
        <td><strong>Formicanera</strong></td>
        <td class="bold-gold">€64</td>
        <td class="check">✓ Nativa</td>
        <td><strong>Unica piattaforma con integrazione Archibald ERP già operativa.</strong> Adattamento completo normative italiane (P.IVA, NC, SDI). Zero costi opachi.</td>
      </tr>
      <tr>
        <td><strong>Pepperi Corporate</strong></td>
        <td>~€72</td>
        <td class="partial">Plugin</td>
        <td>Partner locale obbligatorio. Onboarding aggiuntivo: €5.000–€46.000. Nessuna integrazione Archibald.</td>
      </tr>
      <tr>
        <td><strong>MS Dynamics 365 Enterprise</strong></td>
        <td>~€97</td>
        <td class="partial">BC nativa</td>
        <td>Licenza solo punto di partenza. Power Platform aggiuntivo. Customization necessaria per workflow italiano.</td>
      </tr>
      <tr>
        <td><strong>Salesforce Enterprise</strong></td>
        <td>~€152</td>
        <td class="cross">✗ (MuleSoft)</td>
        <td>ERP integration via MuleSoft: €50.000/anno aggiuntivi. TCO 3 anni: €465.000.</td>
      </tr>
    </tbody>
  </table>
  <p class="market-note">* Prezzi verificati maggio 2026 su fonti pubbliche (Pepperi, Delta Sales App, RepMove, Badger Maps, Microsoft, Salesforce). Skynamo su range da fonti terze (G2, FieldSalesTools). Conversione USD/EUR a cambio ECB 16 aprile 2026: 1 EUR = 1,1782 USD.</p>

  <div class="callout callout-navy" style="margin-top:16px;">
    <p><strong>TCO comparativo su 3 anni (60–80 utenti):</strong> Formicanera ~€187.000 · Skynamo ~€175.000–210.000 (+ impl.) · Pepperi ~€206.000–241.000 · Dynamics 365 ~€283.000 · Salesforce ~€465.000.<br><strong>Il prezzo non è negoziabile perché è già il prezzo di mercato — è competitivo, non di favore.</strong></p>
  </div>
</div>
...
<div style="min-height:297mm;display:flex;flex-direction:column;background:var(--bg);">
  <div style="flex:1;padding:38px 68px 30px;">
    ...
    <div class="steps">
      <div class="step">
        ...
        <div class="step-desc">Conferma scritta entro il 31 Luglio 2026</div>
      </div>
      <div class="step">
  ...
  <div class="doc-footer" style="margin-top:auto;">
    ...
    <div class="footer-meta">
      Analisi di Mercato &amp; Proposta Commerciale — Maggio 2026<br>
      Riservata — Komet Italia S.r.l. / Gebr. Brasseler GmbH &amp; Co. KG<br>
      Valida fino al 31 Luglio 2026 · Tutti i prezzi IVA esclusa
    </div>
  </div>
</div>
...
const outputPath = join(dirname(fileURLToPath(import.meta.url)), 'doc3-proposta-IT.pdf');
