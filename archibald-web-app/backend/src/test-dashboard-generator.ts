...
async function main() {
  ...
  console.log(
    `   - Contains Gantt chart: ${html.includes("gantt-svg") ? "✅" : "❌"}`,
  );
  console.log(
    `   - Contains bottleneck analysis: ${html.includes("bottleneck-list") ? "✅" : "❌"}`,
  );
  console.log(
    `   - Contains category table: ${html.includes("category-table-body") ? "✅" : "❌"}`,
  );
  console.log(
    `   - Contains timeline table: ${html.includes("timeline-table-body") ? "✅" : "❌"}`,
  );
  ...
  console.log(
    `   ✅ HTML with trends generated: ${(htmlWithTrends.length / 1024).toFixed(1)} KB`,
  );
  console.log(
    `   - Contains trends section: ${htmlWithTrends.includes("trend-charts") ? "✅" : "❌"}`,
  );
